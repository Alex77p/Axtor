...
import android.content.*; import android.net.Uri; import org.json.*; import java.io.*; import java.util.*;
...
public final class AppCore {
  ...
  public static void setActiveModel(Context c,String path){c.getSharedPreferences(PREF,0).edit().putString(ACTIVE_MODEL,path).apply();}
  public static void setFlows(Context c, JSONArray a){c.getSharedPreferences(PREF,0).edit().putString(FLOWS,a.toString()).apply();}
